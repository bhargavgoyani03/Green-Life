            ...
            <div class="tab-content pt-2" id="borderedTabContent">
                ...
                <div class="tab-pane fade show active" id="prod" role="tabpanel" aria-labelledby="prod-tab">
                    <div class="col-xl-12 col-md-6">
                        <div style="background-color:#074f0b" class="card mb-12">
                            <div class="card-body">
                    ...
                    <h3 style="text-align:center;">Total Seller Product Details</h3>
                    <div class="card mt-4">
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <?php echo "<td><a href='SellerProduct.php?Prod_id=" . $row['Prod_id'] . "' class='btn' style='background-color:#074f0b; color:#fff;'>Delete</button></td>"; ?>
                                            <?php echo "<td><a href='sellerprodedit.php?Prod_id=" . $row['Prod_id'] . "' class='btn' name='submit' style='background-color:#074f0b; color:#fff'>Edit</button></td>"; ?>
                                        </tr>
                                    <?php
                                    }
                ...
                <div class="tab-pane fade" id="detail" role="tabpanel" aria-labelledby="detail-tab">
                    <h3 style="text-align:center;">Add Product Form</h3>
                    <div class="card mt-4">
                        <div class="card-body">
