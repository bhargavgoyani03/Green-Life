        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <div class="tab-content pt-2" id="borderedTabContent">
                ...
                <div class="tab-pane fade" id="bordered-profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="col-xl-12 col-md-6">
                            <div class="card mb-4" style="background-color:#074f0b">
                                <div class="card-body">
                                    ...
                                    <?php
                                    $query = "SELECT * FROM info_type WHERE Type='Humidity' ";
                                    $query_run = mysqli_query($conn, $query);
                                    if ($HumidityTotal = mysqli_num_rows($query_run)) {
                                        echo '<h4 class="mb-0" style="color:#fff;">' . $HumidityTotal . '</h4>';
                                    } else {
                    ...
                    <h3 style="text-align:center;">Total humidity opinion share detail</h3>
                    <div class="card mt-4">
                        <div class="card-body">
                            <table class="table table-borderless datatable" id="myTable">
                                ...
                                <tbody>
                                    <?php
                                    $sql = "SELECT * FROM `info_type` WHERE Type='Humidity' ";
