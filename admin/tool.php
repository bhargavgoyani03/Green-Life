                ...
                <div class="p-4 pt-5">
                    ...
                    <ul class="list-unstyled components mb-5">
                        <li>
                            ...
                            <a href="gdashbord.php" data-toggle="collapse" aria-expanded="false">Home</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="Product.php" data-toggle="collapse" aria-expanded="false">Product</a>
                        </li>
                        <li>
            ...
            <div id="content" class="p-4 p-md-5">
                ...
                <div class="tab-content pt-2" id="borderedTabContent">
                    <div class="tab-pane fade show active" id="bordered-home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="col-xl-12 col-md-6">
                                <div class="card mb-4" style="background-color:#074f0b">
                                    <div class="card-body">
                                        ...
                                        <?php
                                        $dash_tool_query = "SELECT * FROM product_category WHERE Pc_id=1";
                                        $dash_tool_query_run = mysqli_query($conn, $dash_tool_query);
                                        if ($Pc_idtotal = mysqli_num_rows($dash_tool_query_run)) {
                        ...
                        <h3 style="text-align:center;">Total Tool Product Detail</h3>
                        <div class="card mt-4">
                            <div class="card-body">
                                <table class="table table-borderless datatable" id="myTable">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT * FROM `product` WHERE Prod_id=1";
